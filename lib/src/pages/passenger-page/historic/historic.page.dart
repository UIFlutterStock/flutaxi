...
class _HistoricPageState extends State<HistoricPage> {
  ...
  TravelPassengerBloc _viagemBloc;


  @override
  void initState() {
    _viagemBloc = BlocProvider.getBloc<TravelPassengerBloc>();
          ...
          child: StreamBuilder(
              ...
              builder:
                ...
                if (listaViagens.length  == 0)
                  return Center(child: Container(child: Text('There are no registered trips!!',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),));
