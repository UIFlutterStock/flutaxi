  ...
  void _registerWithEmailPass(BuildContext contect) {
    if (_formKey.currentState.validate()) {
      ...
      _auth
        ...
        ShowSnackBar.build(
            widget._scaffoldLoginKey, 'Congratulations, Successfully Created User!', context);
      }, onError: (ex) {
        widget._baseBloc.loadingStatusEvent.add(false);
        switch (ex.code) {
          case "ERROR_EMAIL_ALREADY_IN_USE":
            ShowSnackBar.build(
                widget._scaffoldLoginKey, 'Attention, There is already a user with this email!', context);
            break;
          case "ERROR_INVALID_EMAIL":
            ShowSnackBar.build(
                widget._scaffoldLoginKey, 'Warning, Invalid Email!', context);
